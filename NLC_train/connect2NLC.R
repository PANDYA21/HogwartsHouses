...
username = creds.potter$credentials$username # "1f8006fe-d57a-4201-93b6-0563b1573a67" # "abc123-####-####-YOUR-CREDS-HERE" #### BE VERY CAREFUL TO understand "Instantiating Credentials" from bound service vs "Service Credentials"
password = creds.potter$credentials$password # "EhscvrMhWnzg" # "123456789ABC"  # you need your own ## if you are having authentication issues , may need the other creds.
...
# write.csv(read.csv2("RacketTextClass2.csv"), file = "RacketTextClass.csv", row.names = F)
thefile <- "NLC_train/trainNLC_potter.csv"
thename <- "\"Potter01\""
